...
# Model identifier (Change this to your specific LM Studio model identifier, or leave as "your-model" to auto-detect loaded model)
MODEL = "your-model"
...
def resolve_model_name():
    """Returns the specified MODEL or auto-detects the currently loaded model in LM Studio if MODEL is 'your-model'."""
    if MODEL != "your-model":
        return MODEL
    try:
